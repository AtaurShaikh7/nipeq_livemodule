PROCEDURE SP_FE_HISTPERF_PEERS_REL_OLD (FUNDID in number,RUN_DATE in Date,REP_TYPE in VARCHAR,ResultSet out SYS_REFCURSOR)
...
END SP_FE_HISTPERF_PEERS_REL_OLD;