PROCEDURE SP_FE_LIVE_02_07 (FUNDID in number, INDEXID in number ,RUN_DATE in Date,REP_TYPE in VARCHAR,ResultSet out SYS_REFCURSOR)
  ...
  if (CHECK_EXIST <> 0) then
     ...
     open ResultSet for 
        ...
        security_code_bbisin_intmdt MAPP on (SM.SECURITY_CODE=MAPP.BM_CODE)
         ...
         security_rating_intmdt on ALLD.security_code = security_rating_intmdt.security_code
