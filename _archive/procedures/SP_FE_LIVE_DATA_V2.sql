PROCEDURE SP_FE_LIVE_DATA_V2 (FUNDID in number, INDEXID in number ,RUN_DATE in Date,REP_TYPE in VARCHAR,LOGINID IN VARCHAR,ResultSet out SYS_REFCURSOR)
