PROCEDURE SP_FE_ANALYST_DATA_REL (RUN_DATE in Date,LOGINID in VARCHAR2,SORTBYCOL in VARCHAR2, ResultSet out SYS_REFCURSOR)
    ...
    ( 
      ...
      (
        ...
        (
          ...
          from fund_holdings fh, fund_nav fn where fh.fund_id= fn.fund_id and fh.effective_date= fn.value_date

          and TRUNC(fh.effective_date)= TRUNC(RUN_DATE) 
        ...
        (
          ...
          select fn.fund_id, ic.security_code, to_char(fn.nav/10000000,'99,99,99,99,99,99,999') as AUM from index_constituents ic, 

          fund_nav fn where ic.index_id=9 and TRUNC(ic.effective_date)=TRUNC(RUN_DATE) and trunc(fn.value_date) = TRUNC(RUN_DATE)
